...
#include <ant/detail/core/algorithm.hpp>
...
auto change_coalescer::consume_change(set_change& change) -> void
{
...
auto change_coalescer::consume_change(unset_change& change) -> void
{
