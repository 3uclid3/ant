...
[[maybe_unused]] auto system(
    ...
    query_of<component<0>*, component<1>>,
    query_of<component<0>, component<1>*, exclude<component<2>>>) -> void
{
}

[[maybe_unused]] auto system_env_only(env_of<component<0>>) -> void
{
}

[[maybe_unused]] auto system_changeset_only(changeset_of<set_env<component<0>>>) -> void
{
}

[[maybe_unused]] auto system_query_only(query_of<component<0>>) -> void
{
}

struct system_callable_object
{
    auto operator()(env_of<component<0>>) const -> void
    {
    }
};

[[maybe_unused]] auto system_lambda = [](changeset_of<set_env<component<0>>>) -> void {
};

using system_binding_traits_t = binding_traits<decltype(system)>;
static_assert(std::is_same_v<system_binding_traits_t::changeset, changeset_of<set_env<component<0>>>>);
static_assert(std::is_same_v<system_binding_traits_t::env, env_of<component<0>*>>);
static_assert(type_list_size_v<system_binding_traits_t::queries> == 2);
static_assert(std::is_same_v<type_list_at_t<0, system_binding_traits_t::queries>, query_of<component<0>*, component<1>>>);
static_assert(std::is_same_v<type_list_at_t<1, system_binding_traits_t::queries>, query_of<component<0>, component<1>*, exclude<component<2>>>>);
...
static_assert(std::is_same_v<system_env_only_binding_traits_t::env, env_of<component<0>>>);
...
static_assert(std::is_same_v<system_changeset_only_binding_traits_t::changeset, changeset_of<set_env<component<0>>>>);
...
static_assert(std::is_same_v<type_list_at_t<0, system_query_only_binding_traits_t::queries>, query_of<component<0>>>);
...
static_assert(std::is_same_v<system_callable_object_binding_traits_t::env, env_of<component<0>>>);
...
static_assert(std::is_same_v<system_lambda_binding_traits_t::changeset, changeset_of<set_env<component<0>>>>);
