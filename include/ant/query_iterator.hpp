...
public:
    query_iterator(detail::query_cursor cursor, detail::query_mapping_view mapping) noexcept;
...
private:
    ...
    detail::query_mapping_view _mapping;
};

template<typename Signature>
query_iterator<Signature>::query_iterator(detail::query_cursor cursor, detail::query_mapping_view mapping) noexcept
